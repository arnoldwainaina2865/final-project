...
st.markdown(""" <h3 style="color:#41e5e5;"> FINANCE ANALYTICS DASHBOARD </h3> """, unsafe_allow_html=True)
#load css
...
#side bar
st.sidebar.image("images/logo1.jfif")
...
with a1:
    st.subheader("Product & Quantites", divider="rainbow")
    source=pd.DataFrame({
...
with c2:
    ...
    ax.set_title(f"Histogarm of{feature}")
